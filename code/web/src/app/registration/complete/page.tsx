...
import { getRegistrationState } from "@/lib/api/registration/get-registration-state";
import { completeRegistration } from "@/lib/api/registration/complete-registration";
